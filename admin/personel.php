...
<body>
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    <th>NRP</th><th>Nama</th><th>Pangkat</th><th>Korps</th><th>Jabatan</th><th>Sub Dinas/Bagian</th><th>Role</th><th>Aksi</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($personel as $p): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?hapus=<?= $p['id'] ?>" onclick="return confirm('Hapus personel ini?')" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
    ...
    <div class="modal" id="modalForm">
        <span style="position:absolute; top:10px; right:15px; cursor:pointer; font-size:20px; color:#999;" onclick="tutupModal()">&times;</span>
        ...
        <form method="POST">
            ...
            <label>Password:</label><input type="text" name="password" id="passwordInput" placeholder="Kosongkan jika tidak diubah"><br>
            <label>Role:</label>
